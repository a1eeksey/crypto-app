<template>
  <div class="container">
    ...
    <div :class="{'mobile': !pageMore680}" class="home_content">
      ...
      <div :class="{'mobile': !pageMore1350, 'small-mobile' : !pageMore680}" class="world-wide-users_block">
        <div class="all-text">
          ...
          <div :class="{'small-mobile' : !pageMore680}" class="info-items">
            <!--1-->
            <div>
      ...
      <div :class="{'mobile': !pageMore680}" data-aos="fade-up" class="item-block">
      ...
      <div :class="{'mobile': !pageMore680}" data-aos="fade-in" data-aos-once="true" class="top-crypto">
        ...
        <div @click="setSelectedCrypto(coin)" v-for="coin in this.$store.state.coins.slice(0,3)" :key="coin.id" class="item">
          ...
          <h2 :class="coin.oneHchange > 0 ? 'green' : 'red'" v-if="pageMore800">{{ coin.oneHchange.toFixed(2) }}</h2>
          <h2 :class="coin.twfourHchange > 0 ? 'green' : 'red'">{{ coin.twfourHchange.toFixed(4) }}</h2>
          <h2 :class="coin.sevDchange > 0 ? 'green' : 'red'" v-if="pageMore800">{{ coin.sevDchange.toFixed(2) }}</h2>
